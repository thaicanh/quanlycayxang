                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" placeholder="Tên đăng nhập">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="customCheck">Nhớ tên đăng nhập</label>
                      </div>
                    </div>
                    ...
                    <hr>
                  <div class="text-center">
                    <a class="small" href="dangky.php">Tạo một tài khoản mới</a>
                  </div>
                </div>
              </div>
            </div>
